...
// Column configuration for Equipment
...
interface EquipmentRowProps {
    ...
    columns: typeof EQUIPMENT_COLUMNS;
...
const EquipmentRow = memo(({ 
    ...
    const formatValue = (col: typeof EQUIPMENT_COLUMNS[0], value: unknown): string => {
        ...
        try {
            ...
            const res = await fetch('/api/webhook/devcoBackend', {
                ...
                body: JSON.stringify({
                    ...
                    payload: { type: 'equipment', id: item._id, item: updatedData }
                })
            });
            const result = await res.json();
                        ...
                        <table className="w-full text-[10px] text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {filteredCatalog.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan={EQUIPMENT_COLUMNS.length + 2} className="p-8 text-center text-gray-400 italic">
