...
// Column configuration for Overhead
...
const OverheadRow = memo(({ 
    ...
    const formatValue = (col: typeof OVERHEAD_COLUMNS[0], value: unknown): string => {
...
OverheadRow.displayName = 'OverheadRow';
        ...
        try {
            ...
            const res = await fetch('/api/webhook/devcoBackend', {
                ...
                body: JSON.stringify({
                    ...
                    payload: { type: 'overhead', id: item._id, item: updatedData }
                })
            });
            const result = await res.json();
                        ...
                        <table className="w-full text-[10px] text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {filteredCatalog.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan={OVERHEAD_COLUMNS.length + 2} className="p-8 text-center text-gray-400 italic">
