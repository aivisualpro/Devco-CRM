...
export function AddOverheadEstimateDialogue({
    ...
    const displayCols = ['overhead', 'classification', 'subClassification', 'hourlyRate', 'dailyRate'];
                                        ...
                                        >
                                            ...
                                            {displayCols.map((col) => (
                                                <td key={col} className="p-3 text-gray-700">
                                                    {['hourlyRate', 'dailyRate'].includes(col) ? `$${Number(item[col] || 0).toLocaleString()}` : String(item[col] || '')}
                                                </td>
                                            ))}
                                        </tr>
                                    );
