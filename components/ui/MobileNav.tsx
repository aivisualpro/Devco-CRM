                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            {getMenuContent()?.items.map((item) => {
                                ...
                                const isImplemented = ['/catalogue', '/templates', '/estimates', '/clients', '/employees', '/jobs/schedules', '/jobs/time-cards', '/reports/payroll', '/roles', '/constants', '/chat', '/quickbooks', '/dashboard'].some(path => item.href.startsWith(path));
