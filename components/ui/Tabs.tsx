...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-14 items-center justify-center rounded-full bg-slate-100/80 p-1.5 text-slate-500 border border-slate-200 shadow-inner",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center whitespace-nowrap rounded-full px-8 py-3 text-sm font-black tracking-tight ring-offset-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-white data-[state=active]:text-[#0F4C75] data-[state=active]:shadow-[0_8px_15px_rgba(15,76,117,0.15)] data-[state=active]:scale-[1.02] border-2 border-transparent data-[state=active]:border-[#0F4C75]/10",
      className
    )}
    {...props}
  />
