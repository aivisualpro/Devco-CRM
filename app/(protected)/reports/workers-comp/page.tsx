                    ...
                    <div className="w-[320px] flex items-center gap-2 shrink-0">
                        ...
                        <div className="relative">
                            <button 
                                ...
                                className={`flex items-center gap-1.5 px-3 py-1.5 bg-white rounded-xl border ${isWeekDropdownOpen ? 'border-[#0F4C75] shadow-inner' : 'border-slate-100 shadow-sm'} transition-all`}
                            >
                                <Clock size={12} className="text-[#0F4C75]" />
                                <span className="text-[10px] font-bold text-slate-800">
                                    {selectedWeekLabel === 'all' ? 'All' : weekOptions.find(w => w.value === selectedWeekLabel)?.label?.split(' ')[1] || 'All'}
                                </span>
