                        ...
                        return (
                            <tr key={itemKey} className="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td className="p-1 text-xs text-gray-700" style={{ width: '30%' }}>
                                    <AutoWidthInput
                                        defaultValue={item.miscellaneous !== undefined && item.miscellaneous !== null ? String(item.miscellaneous) : ''}
                                        inputType="text"
                                        onBlur={(newVal) => onUpdateItem?.(item, 'miscellaneous', newVal)}
                                        placeholder="Item"
                                        inputId={`miscellaneous-${i}-0`}
                                    />
                                </td>
                                <td className="p-1 text-xs text-gray-700" style={{ width: '30%' }}>
                                    <AutoWidthInput
