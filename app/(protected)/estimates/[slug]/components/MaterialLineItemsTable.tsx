                        ...
                        return (
                            <tr key={itemKey} className="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td className="p-1 text-xs text-gray-700" style={{ width: '15%' }}>
                                    <AutoWidthInput
                                        defaultValue={item.material !== undefined && item.material !== null ? String(item.material) : ''}
                                        inputType="text"
                                        onBlur={(newVal) => onUpdateItem?.(item, 'material', newVal)}
                                        placeholder="Material"
                                        inputId={`material-${i}-0`}
                                    />
                                </td>
                                ...
                                <td className="p-1 text-xs text-gray-700" style={{ width: '5%' }}>
                                    <AutoWidthInput
                                        ...
                                        placeholder="Cost"
                                        inputId={`material-${i}-6`}
                                    />
                                </td>
                                <td className="p-1 text-xs text-gray-700" style={{ width: '8%' }}>
                                    <AutoWidthInput
                                        defaultValue={item.taxes !== undefined && item.taxes !== null ? String(item.taxes) : ''}
                                        inputType="number"
                                        onBlur={(newVal) => onUpdateItem?.(item, 'taxes', newVal)}
                                        placeholder="Taxes"
                                        inputId={`material-${i}-7`}
                                    />
                                </td>
                                <td className="p-1 text-xs text-gray-700" style={{ width: '5%' }}>
                                    <AutoWidthInput
