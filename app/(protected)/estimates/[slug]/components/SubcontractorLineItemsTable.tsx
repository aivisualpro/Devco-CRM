                            ...
                            <tr key={itemKey} className="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td className="p-1 text-xs text-gray-700" style={{ width: '20%' }}>
                                    <AutoWidthInput
                                        ...
                                        placeholder="Sub"
                                        inputId={`subcontractor-${i}-1`}
                                    />
                                </td>
                                <td className="p-1 text-xs text-gray-700" style={{ width: '20%' }}>
                                    <AutoWidthInput
                                        defaultValue={item.contractor !== undefined && item.contractor !== null ? String(item.contractor) : ''}
                                        inputType="text"
                                        onBlur={(newVal) => onUpdateItem?.(item, 'contractor', newVal)}
                                        placeholder="Contractor"
                                        inputId={`subcontractor-${i}-2`}
                                    />
                                </td>
