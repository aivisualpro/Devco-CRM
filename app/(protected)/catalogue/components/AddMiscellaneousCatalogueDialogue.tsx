...
export function AddMiscellaneousCatalogueDialogue({
    ...
    const handleSave = async () => {
        ...
        if (processedData.quantity) processedData.quantity = parseFloat(processedData.quantity) || 0;
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-white sticky top-0 z-10">
                    <div>
                        <h2 className="text-xl font-bold text-gray-900 tracking-tight">
                            {isEditing ? 'Edit Miscellaneous' : 'Add New Miscellaneous'}
                        </h2>
                        <p className="text-sm text-gray-500 mt-0.5">Manage custom items and unclassified costs.</p>
                    </div>
