...
export default function BillingTicketsClient({ initialEstimates = [] }: { initialEstimates?: Estimate[] }) {
    ...
    const [loading, setLoading] = useState(initialEstimates.length === 0);
    ...
    useEffect(() => {
        // Only fetch on mount if no server-provided data
                                                    ...
                                                    <TableCell>
                                                        {can(MODULES.ESTIMATES, ACTIONS.VIEW) ? (
                                                            <span
                                                                ...
                                                                onMouseEnter={() => router.prefetch(`/estimates/${ticket.estimateNumber}`)} onClick={() => router.push(`/estimates/${ticket.estimateNumber}`)}
                                                            >
                                                                {ticket.estimateNumber || 'N/A'}
                                                            </span>
                                                        ) : (
