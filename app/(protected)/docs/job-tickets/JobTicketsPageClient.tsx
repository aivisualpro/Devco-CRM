...
export default function JobTicketPageClient({ initialDjts = [], initialTotal = 0 }: { initialDjts?: any[]; initialTotal?: number }) {
    ...
    // Data State
    const [djts, setDjts] = useState<DJT[]>(initialDjts as DJT[]); // Separated state for DJT list
    const [totalDJTs, setTotalDJTs] = useState(initialTotal);
