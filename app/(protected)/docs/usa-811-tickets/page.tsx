                        ...
                        <div className="hidden lg:flex flex-col flex-1 min-h-0">
                            <div className="bg-white rounded-xl shadow-sm border border-slate-200 flex-1 flex flex-col min-h-0 overflow-hidden">
                                <Table containerClassName="flex-1 overflow-auto">
                                    <TableHead>
                                        <TableRow>
                                            <TableHeader className="w-[120px]">Ticket #</TableHeader>
                                            <TableHeader className="w-[90px]">Type</TableHeader>
                                            <TableHeader className="w-[100px]">Status</TableHeader>
                                            <TableHeader className="w-[110px]">Request Date</TableHeader>
                                            <TableHeader className="w-[110px]">Expiration</TableHeader>
                                            <TableHeader className="min-w-[180px]">Address</TableHeader>
                                    ...
                                    <TableBody>
                                        {[...Array(10)].map((_, i) => (
                                            <TableRow key={i} className="border-b border-slate-50">
                                                <TableCell><div className="w-20 h-3 bg-slate-100 rounded animate-pulse" /></TableCell>
                                                <TableCell><div className="w-14 h-4 bg-slate-100 rounded-full animate-pulse" /></TableCell>
                                                <TableCell><div className="w-16 h-4 bg-slate-100 rounded-full animate-pulse" /></TableCell>
                                                <TableCell><div className="w-16 h-3 bg-slate-100 rounded animate-pulse" /></TableCell>
                                                <TableCell><div className="w-16 h-3 bg-slate-100 rounded animate-pulse" /></TableCell>
                                                <TableCell><div className="w-32 h-3 bg-slate-100 rounded animate-pulse" /></TableCell>
                                                ...
                                                <TableCell><div className="w-24 h-3 bg-slate-100 rounded animate-pulse" /></TableCell>
                                                <TableCell><div className="w-20 h-3 bg-slate-100 rounded animate-pulse" /></TableCell>
                                                <TableCell><div className="flex gap-1"><div className="w-10 h-4 bg-amber-50 rounded animate-pulse" /><div className="w-10 h-4 bg-amber-50 rounded animate-pulse" /></div></TableCell>
                                                <TableCell><div className="w-10 h-3 bg-slate-100 rounded animate-pulse ml-auto" /></TableCell>
                                            </TableRow>
                                        ))}
                                    </TableBody>
                                </Table>
