            ...
            <div className="flex-1 overflow-y-auto bg-[#f8fafc] overflow-x-hidden">
                <div className="max-w-[1600px] mx-auto p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    dailySchedules.map((item, i) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex flex-col h-full">
                                                ...
                                                {/* Row 3: Job Location */}
                                                <p className="text-xs font-medium text-slate-400 truncate mb-3">{item.jobLocation}</p>
                        ...
                        <div className={`bg-white rounded-2xl p-4 border border-slate-100 shadow-sm ${mounted ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '600ms' }}>
