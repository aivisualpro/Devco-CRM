...
export async function POST(req: NextRequest) {
    try {
        ...
        const { emailTo, subject, emailBody, attachment, potholeLogId } = body;

        if (!emailTo || !attachment || !potholeLogId) {
            console.error('Missing fields:', { hasEmailTo: !!emailTo, hasAttachment: !!attachment, hasPotholeLogId: !!potholeLogId });
